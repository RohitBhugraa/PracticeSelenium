...
public void simpleActionsOnHomePage() {
		...
		WebElement itemInSubCategory = getDriver().findElement(By.xpath("//span[text()='East Asian Foods']"));
		action.moveToElement(itemInSubCategory).build().perform();
		waitABit(2000);
